...
import com.accounting.easyaccountant.adapters.SalesPayRecyclerViewAdapter;
...
public class SalesFragment extends Fragment {
    ...
    SalesPayRecyclerViewAdapter adapter ;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new SalesPayRecyclerViewAdapter(DatabaseHandler.getInstance().getAllBills());
